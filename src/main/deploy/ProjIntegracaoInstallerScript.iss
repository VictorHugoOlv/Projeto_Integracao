...
DefaultDirName={pf}\ProjetoIntegracao
DisableProgramGroupPage=yes
OutputDir=C:\repo\Instalador Projeto Integracao\installer
...
[Files]
Source: "C:\repo\repos_clonados\front\target\ProjetoIntegracao-1.0-SNAPSHOT.exe"; DestDir: "{app}"; Flags: ignoreversion
